...
var (
	...
	ErrInvalidCookieName = errors.New(
		"jwt cookie names must not be empty or contain invalid characters",
	)
	...
	ErrSignerUnequal         = errors.New(
		"jwt signer must be equal to the signer used to sign the token",
	)
)
