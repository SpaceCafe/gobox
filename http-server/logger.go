...
func (r *LogEntry) String() string {
	...
	b.WriteString(r.StatusCodeColor())
	b.WriteString(" | ")
	logger.LeftPadString(&b, r.Latency.String(), 13) //nolint:mnd // Fixed string size
	b.WriteString(" | ")
	logger.LeftPadString(&b, r.ClientIP, 15) //nolint:mnd // Fixed string size
	b.WriteString(" | ")
	b.WriteString(r.MethodColor())
	b.WriteByte(' ')
	b.WriteString(r.Path)

	if r.Errors != "" {
		b.WriteByte(' ')
		b.WriteString(r.Errors)
	}
