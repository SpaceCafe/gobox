...
type ServiceDeleter[T any] interface {
	...
	Delete(resource Resource[T], options *ServiceOptions, entity *T) error
}
...
type ServiceReader[T any] interface {
	...
	Read(resource Resource[T], options *ServiceOptions, entity *T) (readEntity *T, err error)
}
...
type ServiceUpdater[T any] interface {
	...
	Update(resource Resource[T], options *ServiceOptions, entity *T) (updatedEntity *T, err error)
}
